...
const form=document.getElementById('authForm'), message=document.getElementById('authMessage'), submit=form.querySelector('button'), email=document.getElementById('email'), password=document.getElementById('password');
